...
if(!isset($_SESSION['email'])){
    ...
    if(isset($_POST['savePost'])){
        ...
        $postProjectSql = "INSERT INTO `project` (`title`,`category`,`cover`,`body`) VALUES ('$title','$category','$cover','$body')";
...
<div class="ProjectContainer">
    ...
    <div class="projectRow">
        <form action="index.php?page=project" method="POST" enctype="multipart/form-data" >
